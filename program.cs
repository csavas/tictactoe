...
/// <summary>
/// MODIFIED C# TIC TAC TOE FROM https://www.c-sharpcorner.com/UploadFile/75a48f/tic-tac-toe-game-in-C-Sharp/
...
/// The computer plays by selecting a random number to place its O
/// </summary>
namespace TIC_TAC_TOE
{
    class Program
    {
        ...
        static int playerComputer; //this holds whether the game is against another player or a computer
        ...
        {
            Console.WriteLine("Welcome to C# TIC TAC TOE! \n");
            Console.WriteLine("Please choose whether you would like to play against another player (enter 0) or a computer (enter 1). \n");
            playerComputer = int.Parse(Console.ReadLine());//Taking users choice 
            do
            {
                ...
                Console.WriteLine("\n");
                if (player % 2 == 0 && playerComputer == 0)//checking the chance of the player
                {
                ...
                else if (player % 2 == 0 && playerComputer == 1) {
                    Console.WriteLine("Computer Chance");
                    Console.WriteLine("\n");
                    Board();// calling the board Function
                    choice = RandomNumber(1, 9);//Taking computer's choice
                    do
                    {
